...
### VGG11 cifar10 res32--> None, ZCApre, ZCAconv0, lmscone, lmscone+ZCAconv0
mmd_iid = np.load('./MMD_values/vgg11_cifar10res32/MMD_iid_gap_randinit.npy', allow_pickle=True).item()
mmd_non_iid = np.load('./MMD_values/vgg11_cifar10res32/MMD_non_iid_gap_randinit.npy', allow_pickle=True).item()
mmd_iid_zcapre = np.load('./MMD_values/vgg11_cifar10res32/MMD_iid_gap_randinit_ZCApre.npy', allow_pickle=True).item()
mmd_non_iid_zcapre = np.load('./MMD_values/vgg11_cifar10res32/MMD_non_iid_gap_randinit_ZCApre.npy', allow_pickle=True).item()
# mmd_iid_zcaconv0 = np.load('./MMD_values/vgg11conv0_cifar10res32/MMD_iid_gap_randinit_ZCAconv0.npy', allow_pickle=True).item()
# mmd_non_iid_zcaconv0 = np.load('./MMD_values/vgg11conv0_cifar10res32/MMD_non_iid_gap_randinit_ZCAconv0.npy', allow_pickle=True).item()
# mmd_iid_lmscone = np.load('./MMD_values/vgg11_cifar10res32/MMD_iid_gap_randinit_lmscone.npy', allow_pickle=True).item()
# mmd_non_iid_lmscone = np.load('./MMD_values/vgg11_cifar10res32/MMD_non_iid_gap_randinit_lmscone.npy', allow_pickle=True).item()
# mmd_iid_lmscone_zcaconv0 = np.load('./MMD_values/vgg11conv0_cifar10res32/MMD_iid_gap_randinit_lmscone_ZCAconv0.npy', allow_pickle=True).item()
# mmd_non_iid_lmscone_zcaconv0 = np.load('./MMD_values/vgg11conv0_cifar10res32/MMD_non_iid_gap_randinit_lmscone_ZCAconv0.npy', allow_pickle=True).item()
mmd_iid_lmscone_zcapre = np.load('MMD_values/vgg11_cifar10res32/MMD_iid_gap_randinit_lmscone_ZCApre.npy', allow_pickle=True).item()
mmd_non_iid_lmscone_zcapre = np.load('./MMD_values/vgg11_cifar10res32/MMD_non_iid_gap_randinit_lmscone_ZCApre.npy', allow_pickle=True).item()
...
plt.plot(np.arange(1, num_layers), mmd_iid_lmscone_zcapre.values(), 'o-', color='purple', label='IID lmscone ZCApre')
plt.plot(np.arange(1, num_layers), mmd_non_iid_lmscone_zcapre.values(), 'o-', color='purple', label='Non-IID lmscone ZCApre')
...
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.title('Cifar10 32 - Random Init VGG11 - MMD Analysis - GAP')
plt.savefig(f'./{save_dir}/MMD_cifar10res32_vgg11.png', bbox_inches='tight')
plt.close()
